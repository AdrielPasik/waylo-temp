...
const WayloApp = ()=>{
    ...
    const [trip, setTrip] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
    ...
    const [tempTitle, setTempTitle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(trip.title);
    ...
    const [tempBudget, setTempBudget] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(trip.budget.toString());
    ...
    const handleAddOrEditDestination = async (data)=>{
        if (editingId) {
            setTrip((prev)=>({
                    ...prev,
                    destinations: prev.destinations.map((d)=>d.id === editingId ? {
                            ...data,
                            id: editingId
                        } : d)
                }));
    ...
    const addOrUpdateExpense = (data)=>{
        if (editingId) {
            setTrip((prev)=>({
                    ...prev,
                    expenses: prev.expenses.map((e)=>e.id === editingId ? {
                            ...data,
                            id: editingId
                        } : e)
                }));
    ...
    const syncLogisticsToExpense = (linkedId, desc, category, amount, currency, date)=>{
        setTrip((prev)=>{
    ...
    const addOrUpdateTransport = (data)=>{
        ...
        setTrip((prev)=>({
                ...prev,
                transportation: editingId ? prev.transportation.map((t)=>t.id === editingId ? newTransport : t) : [
                    ...prev.transportation,
                    newTransport
                ]
            }));
        if (data.cost && data.cost > 0) {
            syncLogisticsToExpense(transportId, `Transporte: ${data.type} (${data.from} - ${data.to})`, "Transporte", data.cost, data.currency, data.date);
        }
        setEditingId(null);
    };
    const addOrUpdateHotel = (data)=>{
        ...
        setTrip((prev)=>({
                ...prev,
                accommodations: editingId ? prev.accommodations.map((a)=>a.id === editingId ? newHotel : a) : [
                    ...prev.accommodations,
                    newHotel
                ]
            }));
        if (data.cost && data.cost > 0) {
            syncLogisticsToExpense(hotelId, `Alojamiento: ${data.name} (${data.city})`, "Alojamiento", data.cost, data.currency, data.checkIn);
        }
        setEditingId(null);
    };
    ...
    return(// Mobile header with menu button
    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen bg-slate-50 font-sans",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "lg:hidden fixed top-0 left-0 right-0 z-50 bg-[#0a1628] text-white px-4 py-3 flex items-center justify-between shadow-lg",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                trip.accommodations.map((a)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex justify-between items-center group",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "flex gap-4 items-center",
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                onSubmit: async (e)=>{
                                                    ...
                                                    if (modalType === "hotel") addOrUpdateHotel({
                                                        name: f.get("name"),
                                                        city: f.get("city"),
                                                        checkIn: f.get("in"),
                                                        checkOut: f.get("out"),
...
_s1(WayloApp, "N57HQc+kZnXA9buOUKIHqmHk6T4=");
_c1 = WayloApp;
...
//# sourceMappingURL=frontend_98b9e764._.js.map