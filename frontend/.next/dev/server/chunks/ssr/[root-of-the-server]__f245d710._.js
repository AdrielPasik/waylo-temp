...
apiClient.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        isRefreshing = true;
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5000/api") || 'http://localhost:5000/api'}/auth/refresh`, {}, {
                withCredentials: true
            });
...
"[project]/frontend/lib/api/auth.service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const authService = {
    login: (credentials)=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', credentials),
    register: (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', data),
    logout: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/logout'),
    getCurrentUser: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/auth/me'),
    refreshToken: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/refresh')
};
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/api/auth.service.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initAuth = async ()=>{
            ...
            if (token) {
                try {
                    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].getCurrentUser();
    ...
    const login = async (credentials)=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].login(credentials);
        localStorage.setItem('accessToken', data.data.accessToken);
        setUser(data.data.user);
    };
    const register = async (registerData)=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].register(registerData);
        localStorage.setItem('accessToken', data.data.accessToken);
        setUser(data.data.user);
    };
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].logout();
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f245d710._.js.map